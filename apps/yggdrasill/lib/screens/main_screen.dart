...
class _UtilityMemoIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(lineStart, secondY), Offset(lineEnd, secondY), paint);
  }
                        ...
                        children: [
                          ...
                          Expanded(
                            child: FileShortcutTab(
                              ...
                              presentation:
                                  FileShortcutPresentation.bottomSheet,
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: PdfEditPanel(
                              dialogContext: dialogContext,
                              presentation:
                                  PdfEditPanelPresentation.bottomSheet,
                            ),
                          ),
                        ],
                      ),
...
class _MainScreenState extends State<MainScreen>
  ...
  void initState() {
    ...
    _sideSheetAnimation.addListener(_syncLeftSideSheetClipWidth);
  ...
  void dispose() {
    ...
    _sideSheetAnimation.removeListener(_syncLeftSideSheetClipWidth);
  ...
  void _syncLeftSideSheetClipWidth() {
    if (!mounted) return;
    final screenWidth = MediaQuery.sizeOf(context).width;
    final maxWidth = _resolveSideSheetMaxWidth(screenWidth);
    final clipWidth =
        (maxWidth * _sideSheetAnimation.value).clamp(0.0, maxWidth);
    if (leftSideSheetClipWidthNotifier.value != clipWidth) {
      leftSideSheetClipWidthNotifier.value = clipWidth;
    }
  }
