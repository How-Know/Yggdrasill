          ...
          child: Row(
            ...
            children: [
              ...
              if (widget.showWeekNavigator) ...[
                ...
                if (widget.onExportPressed != null) const SizedBox(width: 6),
                _buildWeekNavigator(),
                const SizedBox(width: 10),
              ],
              if (widget.onClassListSheetToggle != null)
                Tooltip(
                  message: '수업',
