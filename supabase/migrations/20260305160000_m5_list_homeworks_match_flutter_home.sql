-- m5_list_homeworks: match Flutter home menu behavior
-- Show: inProgress items (status=0) with phase 1~4
-- Hide: completed (status=1), homework items with active assignment (status=2 + assigned)
-- Also hide: phase 0 (reserved)
