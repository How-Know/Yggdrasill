-- Atomic create: homework group (optional) + homework_items + homework_group_items (optional)
-- + homework_assignments with reservation note in a single transaction (function body).
...
grant execute on function public.homework_create_reserved_homework_bundle(uuid, uuid, jsonb, jsonb)
  to authenticated;

comment on function public.homework_create_reserved_homework_bundle is
  'Transactionally creates reserved homework: optional group, items, links, and assignments (note=__reserved_homework__).';
