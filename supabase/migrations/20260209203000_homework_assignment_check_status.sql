-- 20260209203000: homework_assignment_check rpc with status
...
revoke all on function public.homework_assignment_check(uuid,uuid,integer,text,text,text,text) from public;
grant execute on function public.homework_assignment_check(uuid,uuid,integer,text,text,text,text) to anon, authenticated;
