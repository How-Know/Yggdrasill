...
export function buildExtractAnswersPrompt({
  ...
  return [
    ...
    '      "answer_text": "<객관식이면 ①~⑤ 중 하나. 주관식이면 1D LaTeX 원문. 찾지 못하면 빈 문자열>",',
    '      "answer_latex_2d": "<주관식일 때 2D 렌더에 쓸 LaTeX. 객관식이면 빈 문자열>",',
    ...
    '   - 세트형(48~52) 이 묶음으로 같은 답(예: ③) 이면 그 묶음을 하나의 item 으로 두되 problem_number="48~52" 로 기록한다.',
