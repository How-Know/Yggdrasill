...
function buildGaeyuDetectPrompt({ displayPage, rawPage }) {
  ...
  const lines = [
    ...
    '     올리는 실수가 잦다 — 다음을 구분 근거로 삼아라.',
    '     - 개념 번호: 뒤에 이어지는 것이 명사구 제목("소인수분해를 이용하여 약수와',
    '       약수의 개수 구하기")이고, 카드 안은 정의·공식·예시 설명이다. 묻는 문장이 없다.',
    '     - 필수 문제 번호: 보라색 원 안 숫자이고, 뒤에 "~을 구하시오", "~인 것은?"',
    '       처럼 **묻는 문장**이 이어진다. 왼쪽 여백에 유형명이 따로 인쇄된다.',
