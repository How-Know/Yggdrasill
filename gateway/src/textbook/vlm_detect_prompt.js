...
function buildGaeyuDetectPrompt({ displayPage, rawPage }) {
  ...
  const lines = [
    ...
    '[D0-Essential] essential_problem 은 **"필수 문제" 보라색 배지가 그 번호와 같은**',
    '     **줄에 실제로 보일 때만** 쓴다. 배지가 없으면 아무리 번호처럼 생겼어도',
    '     essential_problem 이 아니다. 특히 개념 카드의 개념 번호를 필수 문제로',
    '     올리는 실수가 잦다 — 번호를 하나 볼 때마다 이 순서로 판정하라.',
