...
export function buildDetectProblemsPrompt({
  ...
  let lines = [
    ...
    '    - "A 기본다잡기" 파트 제목만 있고 4자리 문항번호가 하나도 보이지 않는 시작/타이틀 페이지는',
    ...
    '    - 번호 옆에 라벨이 자주 붙는다: "상", "중", "하", "대표 문제", "창의문제", "교육청기출".',
    ...
    '       - 라벨 아이콘/글자 ("상","중","하","대표 문제","창의문제","서술형","교육청기출") → 번호 옆에 딸린 장식이므로 제외.',
